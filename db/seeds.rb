...
3.times do
question_poster = User.create(username: Faker::Internet.user_name, password: '12345', email: Faker::Internet.email)
  ...
  2.times do
    ...
    3.times do
      answer_poster = User.create(username: Faker::Internet.user_name, password: '12345', email: Faker::Internet.email)
      answer = question.answers.create(user_id: answer_poster.id, content: Faker::Lorem.paragraph)
      3.times do
        answer_comment_poster = User.create(username: Faker::Internet.user_name, password: '12345', email: Faker::Internet.email)
        answer.comments.create(user_id: answer_comment_poster.id, content: Faker::Lorem.paragraph)
      end
    end
    4.times do
      comment_poster = User.create(username: Faker::Internet.user_name, password: '12345', email: Faker::Internet.email)
